...
[![Compatible with Bot API v7.5](https://img.shields.io/badge/Bot%20API%20version-v7.5-blue?style=flat-square)](https://core.telegram.org/bots/api#june-18-2024)

**Telegram.BotAPI** is one of the most complete libraries available to interact with the Telegram Bot API in your .NET projects. It contains all the methods and types available in the Bot API 7.5 released on June 18, 2024.
...
- Contains pre-defined methods for all Bot API 7.5 methods.
- Contains classes for each object type used in the Bot API 7.5.
