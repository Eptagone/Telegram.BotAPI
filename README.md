...
**Telegram.BotAPI** is one of the most complete libraries available to interact with the Telegram Bot API in your .NET projects. It contains all the methods and types available in the Bot API 9.5 released on March 1, 2026.
...
- Contains pre-defined methods for all Bot API 9.5 methods.
- Contains classes for each object type used in the Bot API 9.5.
