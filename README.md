...
It contains all the methods available in the Bot API 5.4 released on November 5, 2021. In addition, it has a complete set of classes with all the objects used.
...
- Contains pre-defined methods for all Bot API 5.4 methods.
- Contains classes for each object type used in the Bot API 5.4.
