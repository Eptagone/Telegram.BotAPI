...
static class Scrapper
{
    ...
    public static async Task<BotApiDefinitions> ScrapBotApiDefinitions()
    {
        using var client = new HttpClient();
        Console.WriteLine("Fetching from {0}", ScriptConstants.TELEGRAM_BOT_API_DOCS_URL);
                            ...
                            )
                            {
                                ...
                                foreach (var tr in tbody.Children)
                                {
                                    ...
                                    var arrayLevels = (ushort)
                                        Regex.Matches(propType, "Array of").Count;
                                    ...
                                    var required = !tr.Children[2]
                                        .TextContent.StartsWith("Optional");
