...
namespace Telegram.BotAPI.InlineMode
{
    ...
    public sealed class InlineQueryResultDocument : InlineQueryResultWithEntities, IInlineQueryResult, ICaption, IExternalThumbnail, IEquatable<InlineQueryResultDocument>
    {
