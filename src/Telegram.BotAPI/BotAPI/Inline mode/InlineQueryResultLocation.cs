...
namespace Telegram.BotAPI.InlineMode
{
    ...
    public sealed class InlineQueryResultLocation : InlineQueryResultWithEntities, ILocation, IInlineQueryResult, IThumbUWH, IEquatable<InlineQueryResultLocation>
    {
