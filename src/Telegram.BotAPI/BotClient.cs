...
public sealed partial class BotClient
{
	...
	/// <exception cref="ArgumentNullException">Thrown when accessToken is null or empty.</exception>
	public BotClient(string botToken, bool ignoreBotExceptions, [Optional] HttpClient httpClient, string serverAddress = "https://api.telegram.org", bool useTestEnvironment = false) : this(botToken, httpClient, serverAddress)
	{
	...
	/// If true, all requests methods will be prefixed with "/test". Example: "/test/getMe".
	/// </summary>
