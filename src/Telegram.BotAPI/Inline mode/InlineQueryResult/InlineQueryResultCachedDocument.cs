...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        ...
        {
            return Equals(obj as InlineQueryResultCachedDocument);
        }
        ...
        public bool Equals(InlineQueryResultCachedDocument other)
        {
            return other != null &&
                   ...
                   Type == other.Type &&
                   DocumentFileId == other.DocumentFileId &&
                   Title == other.Title &&
        ...
        public override int GetHashCode()
        {
            ...
            hashCode = hashCode * -1521134295 + EqualityComparer<string>.Default.GetHashCode(DocumentFileId);
