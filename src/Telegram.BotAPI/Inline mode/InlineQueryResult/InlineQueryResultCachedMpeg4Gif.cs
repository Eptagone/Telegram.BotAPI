...
namespace Telegram.BotAPI.InlineMode
{
    ...
    public sealed class InlineQueryResultCachedMpeg4Gif : InlineQueryResultWithEntities, IInlineQueryResult, ICaption, IEquatable<InlineQueryResultCachedMpeg4Gif>
    {
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        ...
        {
            return Equals(obj as InlineQueryResultCachedMpeg4Gif);
        }
        ...
        public override int GetHashCode()
        {
            ...
            hashCode = hashCode * -1521134295 + EqualityComparer<string>.Default.GetHashCode(Mpeg4FileId);
