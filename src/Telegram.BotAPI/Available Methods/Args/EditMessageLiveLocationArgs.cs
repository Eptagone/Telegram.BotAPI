...
namespace Telegram.BotAPI.AvailableMethods
{
	...
	public class EditMessageLiveLocationArgs : ILocation, ICustomizableReplyMarkup<InlineKeyboardMarkup>
	{
		/// <summary>
		...
		public EditMessageLiveLocationArgs(float longitude, float latitude)
		{
