...
namespace Telegram.BotAPI.AvailableMethods
{
    public static partial class AvailableMethodsExtensions
    {
        ...
        public static bool SetChatPhoto(this BotClient bot, long chatId, InputFile photo)
        {
            ...
            return bot.RPCF<bool>(MethodNames.SetChatPhoto, new SetChatPhotoArgs { ChatId = chatId, Photo = photo });
        }
        ...
        public static async Task<bool> SetChatPhotoAsync(this BotClient bot, long chatId, InputFile photo, [Optional] CancellationToken cancellationToken)
        {
            ...
            return await bot.RPCAF<bool>(MethodNames.SetChatPhoto, new SetChatPhotoArgs { ChatId = chatId, Photo = photo }, cancellationToken: cancellationToken).ConfigureAwait(false);
        }
