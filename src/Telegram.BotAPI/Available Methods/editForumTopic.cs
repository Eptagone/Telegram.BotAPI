...
public static partial class AvailableMethodsExtensions
{
	...
	public static bool EditForumTopic(this BotClient? api, long chatId, int messageThreadId, [Optional] string? name, [Optional] string? iconCustomEmojiId)
	{
	...
	/// <exception cref="BotRequestException">Thrown when a request to Telegram Bot API got an error response.</exception>
	/// <exception cref="ArgumentNullException">Thrown when a required parameter is null.</exception>
	public static bool EditForumTopic(this BotClient? api, string chatId, int messageThreadId, [Optional] string? name, [Optional] string? iconCustomEmojiId)
	{
		if (api == null) { throw new ArgumentNullException(nameof(api)); }
		var stream = new MemoryStream();
		using var json = new Utf8JsonWriter(stream, new JsonWriterOptions { Indented = true });
	...
	/// <exception cref="BotRequestException">Thrown when a request to Telegram Bot API got an error response.</exception>
	/// <exception cref="ArgumentNullException">Thrown when a required parameter is null.</exception>
	public static async Task<bool> EditForumTopicAsync(this BotClient? api, long chatId, int messageThreadId, [Optional] string? name, [Optional] string? iconCustomEmojiId, [Optional] CancellationToken cancellationToken)
	{
		if (api == null) { throw new ArgumentNullException(nameof(api)); }
		var stream = new MemoryStream();
		using var json = new Utf8JsonWriter(stream, new JsonWriterOptions { Indented = true });
	...
	/// <exception cref="BotRequestException">Thrown when a request to Telegram Bot API got an error response.</exception>
	/// <exception cref="ArgumentNullException">Thrown when a required parameter is null.</exception>
	public static async Task<bool> EditForumTopicAsync(this BotClient? api, string chatId, int messageThreadId, [Optional] string? name, [Optional] string? iconCustomEmojiId, [Optional] CancellationToken cancellationToken)
	{
		if (api == null) { throw new ArgumentNullException(nameof(api)); }
		var stream = new MemoryStream();
		using var json = new Utf8JsonWriter(stream, new JsonWriterOptions { Indented = true });
