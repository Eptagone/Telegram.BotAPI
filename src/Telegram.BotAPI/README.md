...
It contains all the methods and types available in the Bot API 6.2 released on August 12, 2022.

---

## Features

- Contains pre-defined methods for all Bot API 6.2 methods.
- Contains classes for each object type used in the Bot API 6.2.
