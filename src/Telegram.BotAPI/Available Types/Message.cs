...
namespace Telegram.BotAPI.AvailableTypes
{
    ...
    public sealed class Message : ICustomizableReplyMarkup<InlineKeyboardMarkup>, IEquatable<Message?>
    {
        ...
        [JsonProperty(DefaultValueHandling = DefaultValueHandling.Ignore)]
        [Obsolete("This field has been replaced by VideoChatScheduled and will be removed in future releases.")]
        public VideoChatScheduled? VoiceChatScheduled { get; set; }
        ///<summary>Optional. Service message: voice chat started.</summary>
        [JsonPropertyName(PropertyNames.VoiceChatStarted)]
        [JsonProperty(DefaultValueHandling = DefaultValueHandling.Ignore)]
        [Obsolete("This field has been replaced by VideoChatStarted and will be removed in future releases.")]
        public VideoChatStarted? VoiceChatStarted { get; set; }
        ///<summary>Optional. Service message: voice chat ended.</summary>
        [JsonPropertyName(PropertyNames.VoiceChatEnded)]
        [JsonProperty(DefaultValueHandling = DefaultValueHandling.Ignore)]
        [Obsolete("This field has been replaced by VideoChatEnded and will be removed in future releases.")]
        public VideoChatEnded? VoiceChatEnded { get; set; }
        ...
        [JsonProperty(DefaultValueHandling = DefaultValueHandling.Ignore)]
        [Obsolete("This field has been replaced by VideoParticipantsInvited and will be removed in future releases.")]
        public VideoChatParticipantsInvited? VoiceChatParticipantsInvited { get; set; }
        /// <summary>
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        ...
        public bool Equals(Message? other)
        {
            return other != null &&
                   ...
                   EqualityComparer<VideoChatParticipantsInvited?>.Default.Equals(VoiceChatParticipantsInvited, other.VoiceChatParticipantsInvited) &&
                   EqualityComparer<VideoChatScheduled?>.Default.Equals(VideoChatScheduled, other.VideoChatScheduled) &&
                   EqualityComparer<VideoChatStarted?>.Default.Equals(VideoChatStarted, other.VideoChatStarted) &&
                   EqualityComparer<VideoChatEnded?>.Default.Equals(VideoChatEnded, other.VideoChatEnded) &&
                   EqualityComparer<VideoChatParticipantsInvited?>.Default.Equals(VideoChatParticipantsInvited, other.VideoChatParticipantsInvited) &&
                   EqualityComparer<WebAppData?>.Default.Equals(WebAppData, other.WebAppData) &&
