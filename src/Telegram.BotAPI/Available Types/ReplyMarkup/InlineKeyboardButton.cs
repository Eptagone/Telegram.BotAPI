...
public sealed class InlineKeyboardButton : IEquatable<InlineKeyboardButton?>
{
	...
	[Obsolete("Use InlineKeyboardButtonExtensions.GetButtonType instead.")]
	public InlineKeyboardButtonType Type => this.GetButtonType();
	...
	[Obsolete("Use InlineButtonBuilder.SetUrl instead.")]
	...
	/// <returns><see cref="InlineKeyboardButton"/></returns>
	[Obsolete("Use InlineButtonBuilder.SetLoginUrl instead.")]
	...
	/// <returns><see cref="InlineKeyboardButton"/></returns>
	[Obsolete("Use InlineButtonBuilder.SetCallbackData instead.")]
	...
	/// <returns><see cref="InlineKeyboardButton"/></returns>
	[Obsolete("Use InlineButtonBuilder.SetSwitchInlineQuery instead.")]
	...
	/// <returns><see cref="InlineKeyboardButton"/></returns>
	[Obsolete("Use InlineButtonBuilder.SetSwitchInlineQueryCurrentChat instead.")]
	...
	/// <returns><see cref="InlineKeyboardButton"/></returns>
	[Obsolete("Use InlineButtonBuilder.SetCallbackGame instead.")]
	...
	/// <param name="text">Button text.</param>
	/// <returns><see cref="InlineKeyboardButton"/></returns>
	[Obsolete("Use InlineButtonBuilder.SetPay instead.")]
	...
	/// <returns><see cref="InlineKeyboardButton"/></returns>
	[Obsolete("Use InlineButtonBuilder.SetWebApp instead.")]
