...
/// </summary>
[Obsolete("Use Telegram.BotAPI.Extensions.InlineKeyboardBuilder instead")]
public static class InlineButtonBuilder
{
	...
	/// <returns><see cref="InlineKeyboardButton"/></returns>
	public static InlineKeyboardButton SetSwitchInlineQueryCurrentChat(
		string text,
	...
	/// <returns><see cref="InlineKeyboardButton"/></returns>
	public static InlineKeyboardButton SetSwitchInlineQueryChosenChat(
		string text,
