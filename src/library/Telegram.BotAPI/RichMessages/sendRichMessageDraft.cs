...
public static partial class RichMessagesExtensions
{
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static bool SendRichMessageDraft(this ITelegramBotClient client, long chatId, int draftId, InputRichMessage richMessage, int? messageThreadId = null) =>
        client.SendRichMessageDraftAsync(chatId, draftId, richMessage, messageThreadId).GetAwaiter().GetResult();
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static Task<bool> SendRichMessageDraftAsync(this ITelegramBotClient client, long chatId, int draftId, InputRichMessage richMessage, int? messageThreadId = null, CancellationToken cancellationToken = default)
    {
        if (client is null)
        {
            throw new ArgumentNullException(nameof(client));
