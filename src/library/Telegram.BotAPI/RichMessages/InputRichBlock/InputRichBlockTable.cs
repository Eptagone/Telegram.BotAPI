...
/// </summary>
public class InputRichBlockTable : InputRichBlock
{
    /// <summary>
    ...
    /// <summary>
    /// Optional. Pass <em>True</em> if the table has borders
    /// </summary>
    [JsonPropertyName(PropertyNames.IsBordered)]
    public bool? IsBordered { get; set; }

    /// <summary>
    /// Optional. Pass <em>True</em> if the table is striped
    /// </summary>
    [JsonPropertyName(PropertyNames.IsStriped)]
    public bool? IsStriped { get; set; }

    /// <summary>
    /// Optional. Pass <em>True</em> if table cells must have smaller indents
    /// </summary>
