...
public interface ITelegramBotClient
{
	...
	Task<TResult> CallMethodAsync<TResult>(string method, object? args = null, CancellationToken cancellationToken = default);
	...
	/// <exception cref="JsonException">The response could not be deserialized.</exception>
	/// <exception cref="OperationCanceledException">The request was canceled.</exception>
	Task<BotResponse<TReturn>> CallMethodDirectAsync<TReturn>(string method, object? args = null, CancellationToken cancellationToken = default);
}