...
public static partial class PaymentsExtensions
{
    ...
    /// <param name="sendPhoneNumberToProvider">Pass <em>True</em> if the user's phone number should be sent to the provider</param>
    /// <param name="sendEmailToProvider">Pass <em>True</em> if the user's email address should be sent to the provider</param>
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static Task<string> CreateInvoiceLinkAsync(this ITelegramBotClient client, string title, string description, string payload, string providerToken, string currency, IEnumerable<LabeledPrice> prices, int? maxTipAmount = null, IEnumerable<int>? suggestedTipAmounts = null, string? providerData = null, string? photoUrl = null, int? photoSize = null, int? photoWidth = null, int? photoHeight = null, bool? needName = null, bool? needPhoneNumber = null, bool? needEmail = null, bool? needShippingAddress = null, bool? sendPhoneNumberToProvider = null, bool? sendEmailToProvider = null, bool? isFlexible = null, CancellationToken cancellationToken = default)
    {
        if (client is null)
        {
            throw new ArgumentNullException(nameof(client));
