...
public static partial class PaymentsExtensions
{
	...
	public static string CreateInvoiceLink(this ITelegramBotClient api, CreateInvoiceLinkArgs args)
	{
		...
		return api.CallMethod<string>(MethodNames.CreateInvoiceLink, args);
	}
	...
	/// <exception cref="BotRequestException">Thrown when a request to Telegram Bot API got an error response.</exception>
	/// <exception cref="ArgumentNullException">Thrown when a required parameter is null.</exception>
	public static async Task<string> CreateInvoiceLinkAsync(this ITelegramBotClient api, CreateInvoiceLinkArgs args, CancellationToken cancellationToken = default)
	{
		if (api == null) { throw new ArgumentNullException(nameof(api)); }
		if (args == default) { throw new ArgumentNullException(nameof(args)); }
		return await api.CallMethodAsync<string>(MethodNames.CreateInvoiceLink, args, cancellationToken).ConfigureAwait(false);
	}
	...
	/// <exception cref="BotRequestException">Thrown when a request to Telegram Bot API got an error response.</exception>
	/// <exception cref="ArgumentNullException">Thrown when a required parameter is null.</exception>
	public static string CreateInvoiceLink(this ITelegramBotClient api, string title, string description, string payload, string providerToken, string currency, IEnumerable<LabeledPrice> prices, [Optional] uint? maxTipAmount, [Optional] IEnumerable<uint>? suggestedTipAmounts, [Optional] string? providerData, [Optional] string? photoUrl, [Optional] uint? photoSize, [Optional] uint? photoWidth, [Optional] uint? photoHeight, [Optional] bool? needName, [Optional] bool? needPhoneNumber, [Optional] bool? needEmail, [Optional] bool? needShippingAddress, [Optional] bool? sendPhoneNumberToProvider, [Optional] bool? sendEmailToProvider, [Optional] bool? isFlexible)
	{
		if (api == null) { throw new ArgumentNullException(nameof(api)); }
	...
	/// <exception cref="BotRequestException">Thrown when a request to Telegram Bot API got an error response.</exception>
	/// <exception cref="ArgumentNullException">Thrown when a required parameter is null.</exception>
	public static async Task<string> CreateInvoiceLinkAsync(this ITelegramBotClient api, string title, string description, string payload, string providerToken, string currency, IEnumerable<LabeledPrice> prices, [Optional] uint? maxTipAmount, [Optional] IEnumerable<uint>? suggestedTipAmounts, [Optional] string? providerData, [Optional] string? photoUrl, [Optional] uint? photoSize, [Optional] uint? photoWidth, [Optional] uint? photoHeight, [Optional] bool? needName, [Optional] bool? needPhoneNumber, [Optional] bool? needEmail, [Optional] bool? needShippingAddress, [Optional] bool? sendPhoneNumberToProvider, [Optional] bool? sendEmailToProvider, [Optional] bool? isFlexible, CancellationToken cancellationToken = default)
	{
		if (api == null) { throw new ArgumentNullException(nameof(api)); }
		var args = new CreateInvoiceLinkArgs(title, description, payload, providerToken, currency, prices)
		{
