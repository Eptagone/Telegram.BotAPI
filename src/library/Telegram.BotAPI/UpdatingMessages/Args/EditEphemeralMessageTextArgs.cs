...
/// </summary>
public class EditEphemeralMessageTextArgs
{
    /// <summary>
    ...
    public EditEphemeralMessageTextArgs(long chatId, long receiverUserId, int ephemeralMessageId, string text)
    {
        this.ChatId = chatId;
    ...
    /// <param name="ephemeralMessageId">Identifier of the ephemeral message to edit</param>
    /// <param name="text">New text of the message, 1-4096 characters after entity parsing</param>
    public EditEphemeralMessageTextArgs(string chatId, long receiverUserId, int ephemeralMessageId, string text)
    {
