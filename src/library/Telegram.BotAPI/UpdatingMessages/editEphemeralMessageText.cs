...
public static partial class UpdatingMessagesExtensions
{
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static bool EditEphemeralMessageText(this ITelegramBotClient client, long chatId, long receiverUserId, int ephemeralMessageId, string text, string? parseMode = null, IEnumerable<MessageEntity>? entities = null, LinkPreviewOptions? linkPreviewOptions = null, ReplyMarkup? replyMarkup = null) =>
        client.EditEphemeralMessageTextAsync(chatId, receiverUserId, ephemeralMessageId, text, parseMode, entities, linkPreviewOptions, replyMarkup).GetAwaiter().GetResult();
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static bool EditEphemeralMessageText(this ITelegramBotClient client, string chatId, long receiverUserId, int ephemeralMessageId, string text, string? parseMode = null, IEnumerable<MessageEntity>? entities = null, LinkPreviewOptions? linkPreviewOptions = null, ReplyMarkup? replyMarkup = null) =>
        client.EditEphemeralMessageTextAsync(chatId, receiverUserId, ephemeralMessageId, text, parseMode, entities, linkPreviewOptions, replyMarkup).GetAwaiter().GetResult();
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static Task<bool> EditEphemeralMessageTextAsync(this ITelegramBotClient client, string chatId, long receiverUserId, int ephemeralMessageId, string text, string? parseMode = null, IEnumerable<MessageEntity>? entities = null, LinkPreviewOptions? linkPreviewOptions = null, ReplyMarkup? replyMarkup = null, CancellationToken cancellationToken = default)
    {
        if (client is null)
        {
            throw new ArgumentNullException(nameof(client));
