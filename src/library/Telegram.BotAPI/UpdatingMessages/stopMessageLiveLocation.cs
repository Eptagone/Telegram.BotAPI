...
public static partial class UpdatingMessagesExtensions
{
    ...
    /// <returns></returns>
    public static TResult StopMessageLiveLocation<TResult>(this ITelegramBotClient client, StopMessageLiveLocationArgs? args = null)
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static Task<TResult> StopMessageLiveLocationAsync<TResult>(this ITelegramBotClient client, StopMessageLiveLocationArgs? args = null, CancellationToken cancellationToken = default)
    {
        if (client is null)
        {
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static Message StopMessageLiveLocation(this ITelegramBotClient client, long chatId, int messageId, ReplyMarkup? replyMarkup = null)
        => client.StopMessageLiveLocationAsync(chatId, messageId, replyMarkup).GetAwaiter().GetResult();
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static Task<Message> StopMessageLiveLocationAsync(this ITelegramBotClient client, long chatId, int messageId, ReplyMarkup? replyMarkup = null, CancellationToken cancellationToken = default)
    {
        if (client is null)
        {
            throw new ArgumentNullException(nameof(client));
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static Message StopMessageLiveLocation(this ITelegramBotClient client, string chatId, int messageId, ReplyMarkup? replyMarkup = null)
        => client.StopMessageLiveLocationAsync(chatId, messageId, replyMarkup).GetAwaiter().GetResult();
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static Task<Message> StopMessageLiveLocationAsync(this ITelegramBotClient client, string chatId, int messageId, ReplyMarkup? replyMarkup = null, CancellationToken cancellationToken = default)
    {
        if (client is null)
        {
            throw new ArgumentNullException(nameof(client));
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static bool StopMessageLiveLocation(this ITelegramBotClient client, string inlineMessageId, ReplyMarkup? replyMarkup = null)
        => client.StopMessageLiveLocationAsync(inlineMessageId, replyMarkup).GetAwaiter().GetResult();
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static Task<bool> StopMessageLiveLocationAsync(this ITelegramBotClient client, string inlineMessageId, ReplyMarkup? replyMarkup = null, CancellationToken cancellationToken = default)
    {
        if (client is null)
        {
            throw new ArgumentNullException(nameof(client));
