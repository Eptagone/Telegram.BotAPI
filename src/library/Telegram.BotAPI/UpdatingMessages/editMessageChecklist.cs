...
public static partial class UpdatingMessagesExtensions
{
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static Message EditMessageChecklist(this ITelegramBotClient client, string businessConnectionId, string chatId, int messageId, InputChecklist checklist, ReplyMarkup? replyMarkup = null) =>
        client.EditMessageChecklistAsync(businessConnectionId, chatId, messageId, checklist, replyMarkup).GetAwaiter().GetResult();
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static Task<Message> EditMessageChecklistAsync(this ITelegramBotClient client, string businessConnectionId, string chatId, int messageId, InputChecklist checklist, ReplyMarkup? replyMarkup = null, CancellationToken cancellationToken = default)
    {
        if (client is null)
        {
            throw new ArgumentNullException(nameof(client));
