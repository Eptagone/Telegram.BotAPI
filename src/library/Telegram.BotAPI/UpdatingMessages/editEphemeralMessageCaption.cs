...
public static partial class UpdatingMessagesExtensions
{
    ...
    /// <param name="args">The arguments for the "EditEphemeralMessageCaption" method.</param>
    /// <exception cref="ArgumentNullException">Thrown if <paramref name="client"/> is <c>null</c>.</exception>
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static bool EditEphemeralMessageCaption(this ITelegramBotClient client, EditEphemeralMessageCaptionArgs args) =>
        client.EditEphemeralMessageCaptionAsync(args).GetAwaiter().GetResult();
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static Task<bool> EditEphemeralMessageCaptionAsync(this ITelegramBotClient client, EditEphemeralMessageCaptionArgs args, CancellationToken cancellationToken = default)
    {
        if (client is null)
        {
        ...
        return client.CallMethodAsync<bool>(MethodNames.EditEphemeralMessageCaption, args, cancellationToken);
    }
