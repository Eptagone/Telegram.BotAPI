...
public static partial class UpdatingMessagesExtensions
{
    ...
    /// <returns></returns>
    public static bool DeleteAllMessageReactions(this ITelegramBotClient client, long chatId, long? userId = null, long? actorChatId = null) =>
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static Task<bool> DeleteAllMessageReactionsAsync(this ITelegramBotClient client, long chatId, long? userId = null, long? actorChatId = null, CancellationToken cancellationToken = default)
    {
        if (client is null)
        {
        ...
        return client.CallMethodAsync<bool>(MethodNames.DeleteAllMessageReactions, args, cancellationToken);
    }
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static bool DeleteAllMessageReactions(this ITelegramBotClient client, string chatId, long? userId = null, long? actorChatId = null) =>
        client.DeleteAllMessageReactionsAsync(chatId, userId, actorChatId).GetAwaiter().GetResult();
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static Task<bool> DeleteAllMessageReactionsAsync(this ITelegramBotClient client, string chatId, long? userId = null, long? actorChatId = null, CancellationToken cancellationToken = default)
    {
        if (client is null)
        {
            throw new ArgumentNullException(nameof(client));
