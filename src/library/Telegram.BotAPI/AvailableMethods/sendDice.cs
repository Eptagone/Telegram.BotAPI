...
public static partial class AvailableMethodsExtensions
{
    ...
    public static Message SendDice(this ITelegramBotClient client, long chatId, string? businessConnectionId = null, int? messageThreadId = null, string? emoji = null, bool? disableNotification = null, bool? protectContent = null, bool? allowPaidBroadcast = null, string? messageEffectId = null, ReplyParameters? replyParameters = null, ReplyMarkup? replyMarkup = null) =>
        client.SendDiceAsync(chatId, businessConnectionId, messageThreadId, emoji, disableNotification, protectContent, allowPaidBroadcast, messageEffectId, replyParameters, replyMarkup).GetAwaiter().GetResult();
