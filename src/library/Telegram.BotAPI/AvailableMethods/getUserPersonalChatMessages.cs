...
public static partial class AvailableMethodsExtensions
{
    ...
    /// <returns></returns>
    public static IEnumerable<Message> GetUserPersonalChatMessages(this ITelegramBotClient client, long userId, int limit) =>
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static Task<IEnumerable<Message>> GetUserPersonalChatMessagesAsync(this ITelegramBotClient client, long userId, int limit, CancellationToken cancellationToken = default)
    {
        if (client is null)
        {
        ...
        return client.CallMethodAsync<IEnumerable<Message>>(MethodNames.GetUserPersonalChatMessages, args, cancellationToken);
    }
}
