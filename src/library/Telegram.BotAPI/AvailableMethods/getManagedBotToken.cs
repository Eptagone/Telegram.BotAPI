...
public static partial class AvailableMethodsExtensions
{
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static Task<string> GetManagedBotTokenAsync(this ITelegramBotClient client, long userId, CancellationToken cancellationToken = default)
    {
        if (client is null)
        {
        ...
        return client.CallMethodAsync<string>(MethodNames.GetManagedBotToken, args, cancellationToken);
    }
}
