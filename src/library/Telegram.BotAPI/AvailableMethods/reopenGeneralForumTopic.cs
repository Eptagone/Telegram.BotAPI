...
public static partial class AvailableMethodsExtensions
{
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static Task<bool> ReopenGeneralForumTopicAsync(this ITelegramBotClient client, long chatId, CancellationToken cancellationToken = default)
    {
        if (client is null)
        {
        ...
        return client.CallMethodAsync<bool>(MethodNames.ReopenGeneralForumTopic, args, cancellationToken);
    }
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static Task<bool> ReopenGeneralForumTopicAsync(this ITelegramBotClient client, string chatId, CancellationToken cancellationToken = default)
    {
        if (client is null)
        {
            throw new ArgumentNullException(nameof(client));
