...
public static partial class AvailableMethodsExtensions
{
    ...
    /// <param name="chatId">Unique identifier for the target chat or username of the target bot or supergroup in the format <em>@username</em>. Channel chats and channel direct messages chats aren't supported.</param>
