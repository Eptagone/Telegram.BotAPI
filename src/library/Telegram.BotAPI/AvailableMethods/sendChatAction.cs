...
public static partial class AvailableMethodsExtensions
{
    ...
    /// <param name="chatId">Unique identifier for the target chat or username of the target supergroup (in the format <em>@supergroupusername</em>). Channel chats and channel direct messages chats aren't supported.</param>
