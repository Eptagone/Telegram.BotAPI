...
public static partial class AvailableMethodsExtensions
{
    ...
    /// <returns></returns>
    public static bool ReopenForumTopic(this ITelegramBotClient client, long chatId, int messageThreadId) =>
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static Task<bool> ReopenForumTopicAsync(this ITelegramBotClient client, long chatId, int messageThreadId, CancellationToken cancellationToken = default)
    {
        if (client is null)
        {
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static bool ReopenForumTopic(this ITelegramBotClient client, string chatId, int messageThreadId) =>
        client.ReopenForumTopicAsync(chatId, messageThreadId).GetAwaiter().GetResult();
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static Task<bool> ReopenForumTopicAsync(this ITelegramBotClient client, string chatId, int messageThreadId, CancellationToken cancellationToken = default)
    {
        if (client is null)
        {
            throw new ArgumentNullException(nameof(client));
