...
public static partial class AvailableMethodsExtensions
{
    ...
    /// <param name="canPostStories">Pass <em>True</em> if the administrator can post stories in the channel; channels only</param>
    /// <param name="canEditStories">Pass <em>True</em> if the administrator can edit stories posted by other users; channels only</param>
    /// <param name="canDeleteStories">Pass <em>True</em> if the administrator can delete stories posted by other users; channels only</param>
    ...
    /// <exception cref="BotRequestException">Thrown if the request to the Telegram Bot API fails.</exception>
    /// <returns></returns>
    public static Task<bool> PromoteChatMemberAsync(this ITelegramBotClient client, long chatId, long userId, bool? isAnonymous = null, bool? canManageChat = null, bool? canDeleteMessages = null, bool? canManageVideoChats = null, bool? canRestrictMembers = null, bool? canPromoteMembers = null, bool? canChangeInfo = null, bool? canInviteUsers = null, bool? canPostMessages = null, bool? canEditMessages = null, bool? canPinMessages = null, bool? canPostStories = null, bool? canEditStories = null, bool? canDeleteStories = null, bool? canManageTopics = null, CancellationToken cancellationToken = default)
    {
        if (client is null)
        {
            throw new ArgumentNullException(nameof(client));
