...
public static partial class StickersExtensions
{
	...
	public static bool CreateNewStickerSet(this ITelegramBotClient bot, CreateNewStickerSetArgs args)
	{
		if (bot == default)
		{
		...
		return bot.CallMethod<bool>(MethodNames.CreateNewStickerSet, args);
	}
	...
	/// <exception cref="BotRequestException">Thrown when a request to Telegram Bot API got an error response.</exception>
	/// <exception cref="ArgumentNullException">Thrown when a required parameter is null.</exception>
	public static async Task<bool> CreateNewStickerSetAsync(this ITelegramBotClient bot, CreateNewStickerSetArgs args, CancellationToken cancellationToken = default)
	{
		if (bot == default)
		{
			throw new ArgumentNullException(nameof(bot));
		...
		return await bot.CallMethodAsync<bool>(MethodNames.CreateNewStickerSet, args, cancellationToken: cancellationToken).ConfigureAwait(false);
	}
