...
public static partial class StickersExtensions
{
    ...
    public static Message SendSticker(this ITelegramBotClient client, long chatId, InputFile sticker, string? businessConnectionId = null, int? messageThreadId = null, string? emoji = null, bool? disableNotification = null, bool? protectContent = null, bool? allowPaidBroadcast = null, string? messageEffectId = null, ReplyParameters? replyParameters = null, ReplyMarkup? replyMarkup = null) =>
        client.SendStickerAsync(chatId, sticker, businessConnectionId, messageThreadId, emoji, disableNotification, protectContent, allowPaidBroadcast, messageEffectId, replyParameters, replyMarkup).GetAwaiter().GetResult();
