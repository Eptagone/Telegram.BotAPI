...
public static partial class StickersExtensions
{
	...
	public static bool SetStickerKeywords<T>(this ITelegramBotClient api, string sticker, [Optional] T? keywords)
		where T : IEnumerable<string>
	{
		...
		return api.CallMethod<bool>(MethodNames.SetStickerKeywords, stream);
	}
	...
	/// <exception cref="ArgumentNullException">Thrown when a required parameter is null.</exception>
	/// <returns>True</returns>
	public static async Task<bool> SetStickerKeywordsAsync<T>(this ITelegramBotClient api, string sticker, [Optional] T? keywords, CancellationToken cancellationToken = default)
		where T : IEnumerable<string>
	{
		if (api == null)
		{
		...
		stream.Seek(0, SeekOrigin.Begin);
		return await api.CallMethodAsync<bool>(MethodNames.SetStickerKeywords, stream, cancellationToken)
