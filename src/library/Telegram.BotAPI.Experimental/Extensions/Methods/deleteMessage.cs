...
public static partial class UpdatingMessagesExtensions
{
	...
	public static bool DeleteMessages(this ITelegramBotClient api, Message message)
	{
		if (api == null)
		{
	...
	/// <exception cref="BotRequestException">Thrown when a request to Telegram Bot API got an error response.</exception>
	/// <exception cref="ArgumentNullException">Thrown when a required parameter is null.</exception>
	public static async Task<bool> DeleteMessagesAsync(this ITelegramBotClient api, Message message, CancellationToken cancellationToken = default)
	{
		if (api == null)
		{
			throw new ArgumentNullException(nameof(api));
